...
**Which state did you choose?** I chose California to do this analysis on.
```{r your-state-analysis, eval = TRUE}
# Remember to change eval=FALSE to eval=TRUE!
# Your code here - adapt from Exercise 9
# (i) Filter for CA
dn_ca <- dennys %>%
...
# (v) Visualize
ggplot(data = dn_lq_ca_mindist, aes(x = closest)) +
  geom_histogram(binwidth = 15) +
  labs(
    title = "Distribution of closest distances between Denny's and La Quinta in California",
    x = "Distance (km)",
    y = "Frequency"
  )
...
I notice that there is a mean closest distance of 22.1km and median closest distance of 11.9km. The standard deviation of the closest distances between La Quinta and Denny's in California is 33.0. The distribution is noticeably larger than both the Alaska, NC, and TX distributions, which only had 3, 28, and 200 points, respectively. The California distribution has 400 points and is skewed right. The Denny's and La Quinta locations here seem to be a lot further than the locations in Texas and Alaska, but closer than the locations in North Carolina.
...
|:------|:---------------------|:-------------------|:------|
| Alaska | 5.20 | 4.41 | Least mean distance, only 3 Denny's locations |
| North Carolina | 53.5 | 65.4 | greatest mean and median distance |
| Texas | 3.37 | 5.79 | Least median distance, 2nd greatest number of locations out of states chosen|
| California | 11.9 | 22.1 | Greatest number of locations out of states chosen|

**Your analysis:**

Which state has the smallest distances on average? What does this tell us about where the joke holds true?

Alaska has the smallest distances between La Quinta and Denny's on average (using mean). Using this information, this tells us that the joke holds true the most in Alaska, however, there are only 3 Denny's locations in Alaska. Texas, however, is the most meaningful state out of the ones selected for the joke, because it balances having a low mean distance with having 200 Denny's locations.
