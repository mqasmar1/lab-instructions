...
The story shows that counties that mandated masks had higher rates of Covid 19 than counties that did not mandate masks. It is weird that both groups are plotted on the same graph when they have different y axis scales. I think the design choice of having 2 y axes that do not start at the same level and not showing axis titles makes the graph misleading. An honest version would have axis titles and having the y axis start at 0 so that the differences are not overemphasized.
---
