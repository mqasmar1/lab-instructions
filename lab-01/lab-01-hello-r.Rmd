...
```{r update-author-name-commit, echo=FALSE, fig.fullwidth=TRUE, fig.height=3, fig.width=3}
...
```{r fig.fullwidth=TRUE, fig.height=3, fig.width=3}
...
```{r all-viz, fig.fullwidth=TRUE, fig.height=3, fig.width=3}
