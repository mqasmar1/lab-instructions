...
# glimpse(Whickham) worked correctly
...
This is an observational study because the researchers are tracking the age and mortality outcomes across smokers and non-smokers. The researchers are not treating the smokers with any medication and are treating it as a closed system.
...
The dataset has `r nrow(Whickham)` observations. Each observation represents a woman who is a smoker or non- smoker, and her age and mortality status after 20 years.
...
**Number of variables:** There are 3 variables in the dataset.
...
| age      |            numerical                 |         continuous (whole numbers)           |
...
I would expect that smokers would have worse health outcomes than non-smokers. I expect that smokers would be affected by lung damage and therefore would have higher mortality rates than non-smokers.
...
ggplot(data = Whickham, aes(x = smoker, fill = outcome)) +
  ...
  labs(
    title = "Relationship between Smoking status and health outcome",
    x = "Smoking status",
    y = "Proportion",
    fill = "Health outcome"
  )
...
- Proportion of smokers who are alive after 20 years: 0.761
- Proportion of non-smokers who are alive after 20 years: 0.686

**Does this meet your expectations? What do you notice?**

This does not match my expectations because I would expect non-smokers to have higher survival rates after 20 years because of the health concerns associated with smoking such as cancer and cardiovascular disease. I wonder why this is the case.
...
ggplot(data = Whickham, aes(x = smoker, fill = outcome)) +
  ...
  facet_wrap(~age_cat) +
  labs(
    title = "Relationship between Health Outcomes and Smoking Status, faceted by age group",
    x = "smoking status",
    y = "proportion",
...
Now, across all three age groups (facets), I see that non-smokers tend to have a higher survival rate than smokers do. This aligns with my initial hypothesis that non-smokers would have better health outcomes than smokers. I think Simpson's paradox might explain this change, and the change was caused by uneven sample sizes and confounding variables.
...
When I added age_cat, the proportions of non-smokers alive after 20 years became higher than the percentage of smokers alive after 20 years for all age groups. For example, using the conditional probability table, I found that 96.5% of non-smokers were alive after 20 years while only 94.7% of smokers were alive after 20 years for age ranges 18-44. 

**Compare the relationship between smoking and outcome:**

Smoking is associated with higher mortality rates after 20 years. There is a positive relationship between the two variables. 

**Overall (from Exercise 5):** Smokers appeared to have higher survival rates.

**Within each age group (from Exercise 7):** Smokers appear to have lower survival rates.
...
People from ages 18-44 had the greatest number of smokers while people over and at the age 65 had the fewest number of smokers. To be more specific, the group 18-44 had 285 smokers, while the age group 65+ had 50 smokers. Also, using the contingency table, people in the age group 18-44 had higher survival rates overall, whether they smoked or did not smoke, compared to other groups. I think that as our bodies stop growing, we feel the effects of smoking more deeply, causing higher mortality rates in 20 years for people in older age groups. Statistically speaking, since more of the smokers were concentrated in the age group 18-44, which had higher survival rates, this caused the overall comparison between smokers and non-smokers to be inadequate for our level of analysis.
